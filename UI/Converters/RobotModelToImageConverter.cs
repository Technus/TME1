...
public class RobotModelToImageConverter : MarkupExtension, IValueConverter
{
  ...
  /// </summary>
  private static readonly List<BitmapImage> _images = [];
  /// <summary>
  /// a dictionary for quick access to bitmap by name
  /// </summary>
  private static readonly Dictionary<string, BitmapImage> _imageDictionary = [];
  ...
  {
    var bitmap = Application.Current.Resources[resourceName] as BitmapImage;
    if (bitmap is null)
  ...
  public object Convert(object value, Type targetType, object parameter, System.Globalization.CultureInfo culture)
  {
    ...
    {
      if(_imageDictionary.TryGetValue(modelName, out var image))
        return image;
      ...
      return _images[Math.Abs(modelNameHash) % _images.Count];
    }
